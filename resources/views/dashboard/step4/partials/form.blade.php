<div class="panel box box-primary">
    ...
    <div id="step4" class="panel-collapse collapse in">
        <div class="box-body">
            ...
            'title_1' => '1. Tem recebido apoio de alguém em situação concreta, facilitando a realização do seu
            tratamento?
            ...
            @include('dashboard.step4.partials.question', [
            'title_1' => '2. Tem recebido apoio de alguém em questões financeiras, como divisão das despesas da casa,
            dinheiro dado ou emprestado?' ,
            ...
            'title' => '5.2 Com base nos tipos de apoio mencionado acima (questões 1 a 5), preencha a opção ou opções
            da(as) pessoa(s) que tem dado esse tipo de apoio?',
            'number' => '5_2'
            ])
            @include('dashboard.step4.partials.question', [
            ...
            @include('dashboard.step4.partials.question', [
            'title_1' => '7. Tem recebido apoio de alguém com quem possa desabafar ou conversar sobre assuntos
            relacionados com a sua doença?',
            'title_2' => '7.1. Em que medida está satisfeito(a) em relação a esse apoio que tem recebido?',
            'number' => '7'
            ])
            @include('dashboard.step4.partials.question', [
            'title_1' => '8. Tem recebido apoio de alguém que lhe oferece informações, melhorando o seu nível de
            ...
            @include('dashboard.step4.partials.question', [
            'title_1' => '11. Tem recebido apoio de alguém quando precisa de companhia para se divertir ou fazer
            atividades de lazer?' ,
            'title_2' => '11.1. Em que medida está satisfeito(a) em relação a esse apoio que tem recebido?',
            'number' => '11'
            ])
            @include('dashboard.step4.partials.question_2', [
            'title' => '12. Com base nos tipos de apoio mencionado acima (questões 6 a 11), preencha a opção ou opções
            da(as) pessoa(s) que tem dado esse tipo de apoio a você?',
            'number' => '12'
            ])
